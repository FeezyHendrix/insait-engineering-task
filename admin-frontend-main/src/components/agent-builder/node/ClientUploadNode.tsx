...
const ClientUploadNode = ({
  ...
  return (
    <div
      className={`ps-2 pt-0 pb-4 border-2 border-[#f5f2f2] rounded-xl font-normal w-[220px] flex flex-col justify-between relative shadow-lg bg-gray-300 overflow-hidden`}
      style={{
    ...
    >
      ...
      />
      <div className='pe-2'>
        {nodeData?.clientVariable?.length > 0 ? (
          <div className='bg-white p-2.5 rounded-sm mt-2.5 border-2 border-[#f5f2f2] shadow-[0px_2px_4px_rgba(0,0,0,0.1)] relative'>
            <p className='m-0 text-base text-[#808080] relative pr-[30px]'>
              {nodeData?.clientVariable}
            </p>
            <>
              <Handle
                type='source'
          ...
          <div className='bg-gray-100 p-2.5 rounded-md mt-2.5 border-2  shadow-[0px_2px_4px_rgba(0,0,0,0.1)] relative'>
            <p className='m-0 text-xs text-gray relative'>
              {t('agentBuilder.selectUploadResponse')}
            </p>
          </div>
        )}
...
export default ClientUploadNode
